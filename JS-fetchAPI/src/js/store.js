...
// de forma asincrona se ejecutan al mismo tiempo las acciones y conforme acaban se van ejecutando, por lo que no va en orden la aparicion de las funciones.
const getUser = async () => {
    try {
